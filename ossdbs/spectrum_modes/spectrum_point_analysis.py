    ...
    def compute(self,
        ...
        for index, frequency in enumerate(frequencies[:2]):
            ...
            if frequency == signal.frequency:
                filename = os.path.join(output, 'solution_130Hz')
                ngsolve.VTKOutput(ma=ng_mesh,
                                  coefs=[solution.potential.real,
                                         solution.potential.imag,
                                         solution.current_density.real,
                                         solution.current_density.imag],
