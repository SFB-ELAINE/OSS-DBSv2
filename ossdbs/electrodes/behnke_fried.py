...
@dataclass
class BehnkeFriedSEEGParameters:
    """Parameters for BehnkeFried electrodes."""
...
class BehnkeFriedSEEGModel(ElectrodeModel):
    """BehnkeFried SEEG electrode.

    Attributes
    ----------
    parameters : BehnkeFriedSEEGParameters
        Parameters for BehnkeFried SEEG electrode geometry.
