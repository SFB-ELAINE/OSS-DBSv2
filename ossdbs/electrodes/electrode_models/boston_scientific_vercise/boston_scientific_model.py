...
@dataclass
class BostonScientificParamerts():
    # dimensions [mm]
    tip_length: float
...
class BostonScientificVerciseDirectedModel(ElectrodeModel):
    ...
    def __init__(self,
                 parameters: BostonScientificParamerts,
                 rotation: float = 0.0,
...
class BostonScientificVerciseModel(ElectrodeModel):
    ...
    def __init__(self,
        ...
        self.__boundaries = {'Body': 'Body',
                             ...
                             'Contact_7': 'Contact_7',
                             'Contact_8': 'Contact_8'}
        self.tip_length = parameters.tip_length
        self.contact_length = parameters.contact_length
        self.contact_spacing = parameters.contact_spacing
        self.lead_diameter = parameters.lead_diameter
