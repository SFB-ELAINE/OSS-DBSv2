...
class BostonScientificVerciseDirectedCustom(ElectrodeModel):
    ...
    def __body(self) -> netgen.libngpy._NgOCC.TopoDS_Shape:
        ...
        body = occ.Cylinder(p=center, d=self.__direction, r=radius, h=height)
    ...
    def __load_parameters(self) -> None:
        ...
        file_name = 'boston_scientific_vercise_directed_custom.json'
