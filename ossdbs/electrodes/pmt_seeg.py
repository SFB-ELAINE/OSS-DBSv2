...
@dataclass
class PMTsEEGParameters:
    """Parameters for PMT electrodes."""
...
class PMTsEEGModel(ElectrodeModel):
    """PMT sEEG Electrodes.

    Attributes
    ----------
    parameters : PMTsEEGParameters
        Parameters for PMT sEEG electrode geometry.
