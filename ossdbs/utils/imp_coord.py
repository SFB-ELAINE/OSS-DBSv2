...
def imp_coord(settings):
    ...
    tip_pos = np.array([electrode["TipPosition"]["x[mm]"],electrode["TipPosition"]["y[mm]"],electrode["TipPosition"]["z[mm]"]])
    ...
    direction = np.array([electrode["Direction"]["x[mm]"],electrode["Direction"]["y[mm]"],electrode["Direction"]["z[mm]"]])
