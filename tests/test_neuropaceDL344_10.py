...
class TestNeuroPaceDL344_10:
    @pytest.fixture
    def NeuroPaceDL344_10_electrode(self):
        return NeuroPaceDL344_10()

    def test_rename_boundaries(self, NeuroPaceDL344_10_electrode):
        """Test whether set_contact_names() works."""
        electrode = NeuroPaceDL344_10_electrode
    ...
    def test_contacts(self, NeuroPaceDL344_10_electrode):
    ...
    def test_electrode_volume(self, NeuroPaceDL344_10_electrode):
    ...
    def test_contacts_volume(self, NeuroPaceDL344_10_electrode):
