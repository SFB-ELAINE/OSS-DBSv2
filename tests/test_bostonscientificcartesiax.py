...
class TestBostonScientificCartesiaX:
    @pytest.fixture
    def BostonScientificCartesiaX_electrode(self):
        return BostonScientificCartesiaX()

    def test_rename_boundaries(self, BostonScientificCartesiaX_electrode):
        """Test whether set_contact_names() works."""
        electrode = BostonScientificCartesiaX_electrode
    ...
    def test_contacts(self, BostonScientificCartesiaX_electrode):
    ...
    def test_electrode_volume(self, BostonScientificCartesiaX_electrode):
    ...
    def test_contacts_volume(self, BostonScientificCartesiaX_electrode):
        ...
        desired = (np.pi * radius**2 * contact_length) + (
