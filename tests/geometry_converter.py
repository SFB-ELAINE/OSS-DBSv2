...
class GeometryConverter:
    ...
    def to_dictionary(self) -> dict:
        ...
        vertices_data = [self.__vertex_to_dict(v) for v in self.__solid.vertices]
        ...
        children = [
            GeometryConverter(solid).to_dictionary() for solid in self.__solid.solids
        ]
