...
class TestDixiMicrotechniquesSEEG15:
    @pytest.fixture
    def DixiSEEG15_electrode(self):
        return DixiSEEG15()

    def test_rename_boundaries(self, DixiSEEG15_electrode):
        """Test whether set_contact_names() works."""
        electrode = DixiSEEG15_electrode
    ...
    def test_contacts(self, DixiSEEG15_electrode):
    ...
    def test_electrode_volume(self, DixiSEEG15_electrode):
    ...
    def test_contacts_volume(self, DixiSEEG15_electrode):
