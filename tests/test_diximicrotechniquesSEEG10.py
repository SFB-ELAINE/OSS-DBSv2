...
class TestDixiMicrotechniquesSEEG10:
    @pytest.fixture
    def DixiSEEG10_electrode(self):
        return DixiSEEG10()

    def test_rename_boundaries(self, DixiSEEG10_electrode):
        """Test whether set_contact_names() works."""
        electrode = DixiSEEG10_electrode
    ...
    def test_contacts(self, DixiSEEG10_electrode):
    ...
    def test_electrode_volume(self, DixiSEEG10_electrode):
    ...
    def test_contacts_volume(self, DixiSEEG10_electrode):
