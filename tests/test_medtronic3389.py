...
class TestMedtronic3389():
    ...
    def test_rename_boundaries(self, Medtronic3389_electrode):
        electrode = Medtronic3389_electrode
    ...
    def test_contacts(self, Medtronic3389_electrode):
        electrode = Medtronic3389_electrode
        geometry = electrode.geometry
        netgen_geometry = netgen.occ.OCCGeometry(geometry)
        with ngsolve.TaskManager():
    ...
    def test_electrode_volume(self, Medtronic3389_electrode):
        electrode = Medtronic3389_electrode
    ...
    def test_contacts_volume(self, Medtronic3389_electrode):
        electrode = Medtronic3389_electrode
