...
class TestMedtronicSenSightB33005:
    @pytest.fixture
    def MedtronicSenSightB33005_electrode(self):
        return MedtronicSenSightB33005()

    def test_rename_boundaries(self, MedtronicSenSightB33005_electrode):
        """Test whether set_contact_names() works."""
        electrode = MedtronicSenSightB33005_electrode
    ...
    def test_contacts(self, MedtronicSenSightB33005_electrode):
    ...
    def test_electrode_volume(self, MedtronicSenSightB33005_electrode):
    ...
    def test_contacts_volume(self, MedtronicSenSightB33005_electrode):
