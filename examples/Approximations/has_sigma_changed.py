...
for material in material_modelCC4.keys():
    ...
    plt.plot(frequencies, conductivitiesCC3[material].real, label=material)
    plt.plot(frequencies, conductivitiesCC3needed[material].real, "o", color="green")
    plt.plot(frequencies, conductivitiesCC3notneeded[material].real, "o", color="red")
plt.yscale("log")
plt.xscale("log")
...
for material in material_modelCC4.keys():
    if material == "CSF":
        continue
    # Plotting conductivity
    plt.plot(frequencies, conductivitiesCC4[material].real, label=material)
    plt.plot(frequencies, conductivitiesCC4needed[material].real, "o", color="green")
    plt.plot(frequencies, conductivitiesCC4notneeded[material].real, "o", color="red")
plt.yscale("log")
plt.xscale("log")
plt.xlabel("Frequency / Hz")
plt.ylabel(r"Real part of conductivity / S m$^{-1}$")
...
for material in material_modelCC4.keys():
    ...
    # Plotting conductivity
    plt.plot(
        frequencies, conductivitiesCC3[material].real, label=material + " real part"
    )
    plt.plot(frequencies, conductivitiesCC3needed[material].real, "o", color="green")
    plt.plot(frequencies, conductivitiesCC3notneeded[material].real, "o", color="red")
    ...
    plt.plot(
        frequencies,
        np.abs(conductivitiesCC3[material].imag),
        "-",
        label=material + " imag. part",
    )
    plt.plot(
        frequencies, np.abs(conductivitiesCC3needed[material].imag), "v", color="green"
    )
    plt.plot(
        frequencies, np.abs(conductivitiesCC3notneeded[material].imag), "v", color="red"
    )
plt.yscale("log")
plt.xscale("log")
plt.xlabel("Frequency / Hz")
...
for material in material_modelCC4.keys():
    ...
    # Plotting conductivity
    plt.plot(
        frequencies, conductivitiesCC4[material].real, label=material + " real part"
    )
    plt.plot(frequencies, conductivitiesCC4needed[material].real, "o", color="green")
    plt.plot(frequencies, conductivitiesCC4notneeded[material].real, "o", color="red")
    ...
    plt.plot(
        frequencies,
        np.abs(conductivitiesCC4[material].imag),
        "-",
        label=material + " imag. part",
    )
    plt.plot(
        frequencies, np.abs(conductivitiesCC4needed[material].imag), "v", color="green"
    )
    plt.plot(
        frequencies, np.abs(conductivitiesCC4notneeded[material].imag), "v", color="red"
    )
plt.yscale("log")
plt.xscale("log")
plt.xlabel("Frequency / Hz")
...
for material in material_modelCC4.keys():
    plt.plot(frequencies, conductivitiesCC3[material].imag / omega / e0, label="CC3")
    plt.plot(
        frequencies,
...
omega = 2.0 * np.pi * frequencies
for material in material_modelCC4.keys():
    plt.plot(frequencies, conductivitiesCC4[material].imag / omega / e0, label="CC4")
    plt.plot(
        frequencies,
...
for material in material_modelCC4.keys():
    plt.plot(
        frequencies[1:],
        np.abs(np.diff(conductivitiesCC3[material].imag))
        / np.abs(conductivitiesCC3[material][0:-1]),
        label=material,
    )
plt.legend()
...
for material in material_modelCC4.keys():
    plt.plot(
        frequencies[1:],
        np.abs(np.diff(conductivitiesCC4[material].imag))
        / np.abs(conductivitiesCC4[material][0:-1]),
        label=material,
    )
plt.legend()
