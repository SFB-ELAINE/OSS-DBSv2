...
def configure_hp_double_material_refinement(base, mri_image, perimeter):
    ...
    cfg["Mesh"]["HPRefinement"] = {"Active": True, "Levels": 2, "Factor": 0.125}
    cfg["Mesh"]["MaterialRefinementSteps"] = 2
    cfg["OutputPath"] = "Results_VTA_hp_double_material_refinement"
    return cfg


def configure_fine_hp_material_refinement(base, mri_image, perimeter):
    """Fine mesh + HP ref. + 1x material ref."""
    cfg = deepcopy(base)
    cfg["Mesh"]["MeshingHypothesis"]["Type"] = "Fine"
    cfg["Mesh"]["HPRefinement"] = {"Active": True, "Levels": 2, "Factor": 0.125}
    cfg["Mesh"]["MaterialRefinementSteps"] = 1
    cfg["OutputPath"] = "Results_VTA_fine_hp_material_refinement"
    return cfg
...
STRATEGIES = [
    ...
    ("hp_double_material_refinement", configure_hp_double_material_refinement),
    ("fine_hp_material_refinement", configure_fine_hp_material_refinement),
    ("best", configure_best),
]
